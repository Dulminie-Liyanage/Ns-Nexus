...
class _OrderScreenState extends State<OrderScreen> {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          widget.isReorder
              ? 'Quick Reorder'
              : (_isUrgent ? 'Urgent Order' : 'New Order'),
                ...
                child: Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      // Qty controls — button + direct typing
                      Row(
                        ...
                        children: [
                          ...
                          // Tappable qty field — opens number keyboard for direct input
                          GestureDetector(
                            onTap: () => _showQtyDialog(id, qty, stockLevel),
                            child: Container(
                              width: 48,
                              height: 32,
            ...
            children: [
              ...
              _isSubmitting
                  ...
                  : ElevatedButton(
                      ...
                      child: Text(
                        _isUrgent ? 'Confirm Urgent Order' : 'Confirm Order',
                        style: const TextStyle(
                          fontSize: 15,
                          fontWeight: FontWeight.w800,
                        ),
  ...
  Widget _buildUrgentBtn() {
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          border: Border.all(
            color: _isUrgent ? Colors.red.shade400 : Colors.amber.shade300,
        ...
        child: Row(
          ...
          children: [
            Icon(
              Icons.bolt_rounded,
              size: 18,
              color: _isUrgent ? Colors.red.shade700 : Colors.amber.shade800,
            ),
            const SizedBox(width: 6),
            Text(
              _isUrgent ? 'Urgent ON' : 'Urgent',
              style: TextStyle(
                color: _isUrgent ? Colors.red.shade700 : Colors.amber.shade900,
                fontWeight: FontWeight.w800,
                fontSize: 13,
              ),
            ),
  ...
  void _showQtyDialog(String productId, int currentQty, int maxQty) {
          ...
          ElevatedButton(
            onPressed: () {
              ...
              if (val <= 0) {
                ...
                final capped = maxQty > 0 ? val.clamp(1, maxQty) : val;
                setState(() => _cart[productId] = capped);
                _calculateTotals();
              }
            },
            style: ElevatedButton.styleFrom(
    ...
    return InkWell(
      ...
      child: Container(
        ...
        child: Icon(
          icon,
          size: 18,
          color: onTap == null ? Colors.grey.shade300 : const Color(0xFF3B82F6),
        ),
      ),
    );
  }
